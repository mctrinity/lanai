        ...
        <div className="mt-10 grid gap-8 md:grid-cols-[1fr_2fr] md:gap-12">
          ...
          <div className="max-w-2xl">
                ...
                <div className="mt-10 space-y-6 text-base leading-8 text-(--muted)">
                    <p>
                        Give me a good book, movie, TV series, or an interesting rabbit hole
                        to disappear into and I&apos;m perfectly content.
                    </p>

                    <p>
                        I love science fiction in almost any form: books, movies, TV shows,
                        comedy or drama. Michael Crichton, Stephen King, and Isaac Asimov are
                        longtime favorites.
                    </p>

                    <p>
                        I play video games when I feel like it, usually single-player.
                        Apparently I&apos;m not particularly sociable in fictional worlds
                        either.
                    </p>

                    <p>
                        I have a habit of getting interested in things and wanting to know how
                        they work, why they work, or why they went horribly wrong.
                    </p>
